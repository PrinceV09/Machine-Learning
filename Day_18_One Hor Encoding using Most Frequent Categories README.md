...
Step 1️⃣ Replace Rare Categories
X_test[col] = X_test[col].where(
    X_test[col].isin(top_categories),
    'Other'
)

Step 2️⃣ Apply One-Hot Encoding
...
Step 3️⃣ Align Test Columns with Train Columns
